...
# from data_analysis.mdp import generate_graph_from_csv
# from data_analysis.gap_statistic import compute_gap
# from data_analysis.mdp import CustomKMeans
# from tool.Yida.tools import data_prcss
#
# save_fig_path = "./imgs/"
# save_mdl_path = "./mdls/"
#
...
#
#
# def compute_mae(y_true, y_predict, labels, config):
#     if not config.algo:
#         if config.mode == 'gap':
...
#         cluster_predict = y_predict[labels == item]
#         cluster_true = y_true[labels == item]
#         mae += sum(sum(abs(cluster_predict - cluster_true)))
#
...
#
#     if config.algo:
#         prcss = data_prcss(9, 2, 1, 1, 1, (1e-3, 1e-3), (1e-3,), (1e-3,), (1e-3,), (1e-1, 1e-1), (1e-2,), (1e-2,),
#                           (1e-2,), (1, 1), (-1, -1), (1,), (-1,), (2,), (0,), (100,), (0,))
#         prcss.read_in('./test.csv')
#         prcss.process()
#         # data.write_csv()
#         prcss.write_csv("./result.csv")
#         graph = generate_graph_from_csv("./result")
#         print(graph)
...
#     # labels = val_data[:, 4]
#     #
#     # compute_mae(y_true, y_predict, labels, config.mode)
#     #TODO：按公式算出来wcss
#     #TODO：sota算法实现，把两个阶段封装在一起
#     #TODO: config至少还有两个参数 mode和是否sota
