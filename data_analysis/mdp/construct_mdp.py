...
class Node:
    ...
    def add_edge(self, next_state, act, reward, cost, done):
        self.edges.append(Edge(next_state, act, reward, cost, done))


class Edge:
    def __init__(self, next_state, act, reward, cost, done):
